package com.winston.ljh.base.adapter.base;
...
public class BaseAdapterHelper {
     ...
     * 使用ImageLoader加载图片
     */
    public BaseAdapterHelper displayImage(int viewId, String url) {
        ImageView view = retrieveView(viewId);
        ImageLoader.getInstance().displayImage(url, new ImageViewAware(view));
        return this;
    }
     ...
     * 使用ImageLoader加载图片
     */
    public BaseAdapterHelper displayImage(int viewId, String url, ImageLoadingListener listener) {
        ImageView view = retrieveView(viewId);
        ImageLoader.getInstance().displayImage(url, new ImageViewAware(view), listener);
        return this;
    }
     ...
     * 使用ImageLoader加载图片
     */
    public BaseAdapterHelper displayImage(int viewId, String url, DisplayImageOptions options) {
        ImageView view = retrieveView(viewId);
        ImageLoader.getInstance().displayImage(url, new ImageViewAware(view), options);
        return this;
    }
     ...
     * 使用ImageLoader加载图片
     */
    public BaseAdapterHelper displayImage(int viewId, String url, DisplayImageOptions options, ImageLoadingListener listener) {
        ImageView view = retrieveView(viewId);
        ImageLoader.getInstance().displayImage(url, new ImageViewAware(view), options, listener);
        return this;
    }
